    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Financeiro / DRE</span>
                    </div>
                    <h1 className="text-3xl font-black text-gray-800 dark:text-white flex items-center gap-3">
                        <Layers size={32} className="text-blue-600" />
                        DRE Gerencial
                    </h1>
                    <p className="text-gray-500 font-bold text-sm">Demonstrativo de Resultados do Exercício.</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-12 rounded-[3rem] border-2 border-dashed border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-500 font-medium max-w-md">Analise a lucratividade do seu negócio com dados precisos em breve.</p>

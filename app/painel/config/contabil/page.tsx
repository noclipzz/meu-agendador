...
export default function ContabilPage() {
    return (
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 p-12 rounded-[2.5rem] border dark:border-gray-800 text-center space-y-4">
            ...
            <h2 className="text-2xl font-black dark:text-white uppercase tracking-tighter">Integração Contábil</h2>
            <p className="text-gray-500 dark:text-gray-400 font-medium max-w-md mx-auto">
                Configure a exportação de dados para seu contador ou integre diretamente com softwares de contabilidade.
            </p>

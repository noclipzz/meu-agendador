...
import { X, CheckCircle, CreditCard, Banknote, QrCode, Loader2, DollarSign, FileBarChart } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <button onClick={() => setMetodo("CREDITO")} className={`p-3 rounded-xl border-2 flex flex-col items-center gap-1 transition ${metodo === "CREDITO" ? "border-green-500 bg-green-50 text-green-700 font-bold" : "border-gray-100 dark:border-gray-700 text-gray-400"}`}>
                <CreditCard size={20} /> <span className="text-xs">Crédito</span>
              </button>
              <button onClick={() => { setMetodo("BOLETO"); setStatusPagamento("PENDENTE"); }} className={`p-3 rounded-xl border-2 flex flex-col items-center gap-1 transition ${metodo === "BOLETO" ? "border-green-500 bg-green-50 text-green-700 font-bold" : "border-gray-100 dark:border-gray-700 text-gray-400"}`}>
                <FileBarChart size={20} /> <span className="text-xs">Boleto</span>
              </button>
            </div>
          </div>

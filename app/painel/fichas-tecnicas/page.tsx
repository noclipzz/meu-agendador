        ...
        const pdfContent = `
            <div id="pdf-container" style="width: 800px; padding: 40px; background: white; color: #1f2937; font-family: 'Inter', sans-serif; position: relative;">
                <style>
                    ...
                    .fields-grid { border-top: 1.5px solid #e2e8f0; border-left: 1.5px solid #e2e8f0; border-radius: 0; display: flex; flex-wrap: wrap; flex-direction: row; background: white; margin-bottom: 30px; width: 100%; box-sizing: border-box; }
        ...
        if (useDigitalSignature && a1Choice && a1Choice !== 'none') {
            ...
            try {
                ...
                if (!pdfBase64 || pdfBase64.length < 1000) {
                    throw new Error("Falha na captura do documento. O PDF gerado está vazio.");
                }

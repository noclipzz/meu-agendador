...
export async function GET() {
    try {
        ...
        if (ownerCompany) {
            ...
            permissions = { dashboard: true, agenda: true, clientes: true, financeiro: true, estoque: true, "fichas-tecnicas": true, servicos: true, profissionais: true, config: true, rastreamento: true };
        } else {

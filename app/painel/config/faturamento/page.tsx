...
export default function ConfigFaturamento() {
    ...
    const activeTab = searchParams.get("tab") || "fiscal";
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 pb-20 p-4 font-sans animate-in fade-in duration-500">
            ...
            <div className="space-y-8">
                {(activeTab === "fiscal" || activeTab === "cobrancas") && (
                ...
                {activeTab === "boletos" && (
                    <div className="bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-sm border dark:border-gray-800 space-y-10">
                        <h3 className="text-xl font-bold mb-6 text-gray-800 dark:text-white flex items-center gap-2">
                            <RotateCcw className="text-orange-500" size={20} /> Integração Cora (Boleto/PIX)
                        </h3>
                ...
                {userRole === "ADMIN" && (
                    <button onClick={salvarConfig} className="bg-black dark:bg-blue-600 text-white px-10 py-5 rounded-[2rem] font-black text-lg shadow-xl hover:scale-[1.02] transition active:scale-95 flex items-center justify-center gap-2 w-full md:w-fit">

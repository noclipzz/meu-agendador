        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Financeiro / Auxiliares</span>
                    </div>
                    <h1 className="text-3xl font-black text-gray-800 dark:text-white flex items-center gap-3">
                        <Settings2 size={32} className="text-blue-600" />
                        Opções Auxiliares
                    </h1>
                    <p className="text-gray-500 font-bold text-sm">Configurações e utilitários financeiros.</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-12 rounded-[3rem] border-2 border-dashed border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center">
                <div className="w-20 h-20 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center mb-6">
                    <Settings2 size={40} className="text-blue-600" />
                </div>
                <h3 className="text-xl font-black dark:text-white mb-2">Módulo em Desenvolvimento</h3>
                <p className="text-gray-500 font-medium max-w-md">Gerencie categorias, métodos de pagamento e taxas em breve.</p>
